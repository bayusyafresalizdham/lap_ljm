 ...
 <script>
		...
		$(document).ready(function(){
			$("#srch").click(function(){
				//alert("ha");
				$.post("ajax/ajax_search.php",{ valuz: $("#edPeriode").val()},function(data){
					$("#tralala").html(data);
				});
			});
		});
 ...
 <form class="form-horizontal" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-2">
		...
		<!-- table yang dipakai adalah VIEW v_rekap_quesioner_biro -->
  ...
  <div class="form-group">
	...
	<div id="tralala" style="width:800px; margin:0 auto; font-family:Century Gothic;"></div>
  </div>
</form>
