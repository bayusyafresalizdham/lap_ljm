 ...
 <h2>
	Laporan Penilaian Dosen Berdasarkan Nama
 </h2>
 ...
 <script>
		...
		$(document).ready(function(){
			$("#srch").click(function(){
				//alert("ha");
				$.post("ajax/ajx_by_name.php",{ valuz: $("#edPeriode").val(),srchby : $('#edJurusan').val()},function(data){
					$("#tralala").html(data);
				});
			});
		});
 ...
 <form class="form-horizontal" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      ...
      <option value="">Tampilkan Semua Dosen</option>
      <?php
